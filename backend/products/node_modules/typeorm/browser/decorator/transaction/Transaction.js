        ...
        descriptor.value = function () {
            ...
            var transactionCallback = function (entityManager) {
                ...
                if (transactionEntityManagerMetadatas.length > 0) {
                    argsWithInjectedTransactionManagerAndRepositories = __spreadArray([], __read(args), false);
                    ...
                    argsWithInjectedTransactionManagerAndRepositories = __spreadArray([entityManager], __read(args), false);
                }
                else {
                    argsWithInjectedTransactionManagerAndRepositories = __spreadArray([], __read(args), false);
                }
