...
const getInstanceName = (instance) => {
    var _a, _b, _c, _d, _e;
    if ((_a = instance) === null || _a === void 0 ? void 0 : _a.forwardRef) {
        return (_b = instance.forwardRef()) === null || _b === void 0 ? void 0 : _b.name;
    }
    if ((_c = instance) === null || _c === void 0 ? void 0 : _c.module) {
        return (_d = instance.module) === null || _d === void 0 ? void 0 : _d.name;
    }
    return (_e = instance) === null || _e === void 0 ? void 0 : _e.name;
};
/**
