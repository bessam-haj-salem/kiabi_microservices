...
let TypeOrmCoreModule = TypeOrmCoreModule_1 = class TypeOrmCoreModule {
    ...
    static forRootAsync(options) {
        const connectionProvider = {
            ...
            useFactory: (typeOrmOptions) => __awaiter(this, void 0, void 0, function* () {
                if (options.name) {
                    return yield this.createConnectionFactory(Object.assign(Object.assign({}, typeOrmOptions), { name: options.name }), options.connectionFactory);
                }
                return yield this.createConnectionFactory(typeOrmOptions, options.connectionFactory);
            }),
    ...
    static createConnectionFactory(options, connectionFactory) {
        return __awaiter(this, void 0, void 0, function* () {
            const connectionToken = typeorm_utils_1.getConnectionName(options);
            const createTypeormConnection = connectionFactory !== null && connectionFactory !== void 0 ? connectionFactory : typeorm_1.createConnection;
            return yield rxjs_1.lastValueFrom(rxjs_1.defer(() => {
                try {
                ...
                if (entities) {
                    ...
                    entities =
                        entities_metadata_storage_1.EntitiesMetadataStorage.getEntitiesByConnection(connectionToken);
                }
                return createTypeormConnection(Object.assign(Object.assign({}, options), { entities }));
