...
class MiddlewareModule {
    ...
    async bindHandler(wrapper, applicationRef, method, path, moduleRef, collection) {
        ...
        if (shared_utils_1.isUndefined(instance === null || instance === void 0 ? void 0 : instance.use)) {
    ...
    async registerHandler(applicationRef, method, path, proxy) {
        ...
        if (Array.isArray(excludedRoutes) &&
            utils_1.isRouteExcluded(excludedRoutes, path, method)) {
            path = shared_utils_1.addLeadingSlash(path);
        }
        else {
        ...
        const isMethodAll = utils_1.isRequestMethodAll(method);
