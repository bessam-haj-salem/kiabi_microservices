...
const filterMiddleware = (middleware, routes, httpAdapter) => {
    const excludedRoutes = exports.mapToExcludeRoute(routes);
    return iterare_1.iterate([])
        .concat(middleware)
        .filter(shared_utils_1.isFunction)
        .map((item) => exports.mapToClass(item, excludedRoutes, httpAdapter))
        .toArray();
};
...
function isMiddlewareClass(middleware) {
    ...
    return (middlewareArr[0] === 'function' &&
        ...
        shared_utils_1.isFunction((_b = middleware.prototype) === null || _b === void 0 ? void 0 : _b.use));
}
...
function isMiddlewareRouteExcluded(req, excludedRoutes, httpAdapter) {
    ...
    const pathname = queryParamsIndex >= 0
        ...
        : originalUrl;
    return utils_1.isRouteExcluded(excludedRoutes, pathname, common_1.RequestMethod[reqMethod]);
}
