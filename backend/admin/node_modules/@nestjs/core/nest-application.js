...
class NestApplication extends nest_application_context_1.NestApplicationContext {
    ...
    applyOptions() {
        ...
        const passCustomOptions = shared_utils_1.isObject(this.appOptions.cors) || shared_utils_1.isFunction(this.appOptions.cors);
    ...
    async listen(port, ...args) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const isCallbackInOriginalArgs = shared_utils_1.isFunction(args[args.length - 1]);
    ...
    formatAddress(address) {
        if (shared_utils_1.isString(address)) {
            ...
            const exclude = options === null || options === void 0 ? void 0 : options.exclude.map((route) => {
                if (shared_utils_1.isString(route)) {
                    return {
                        ...
                        pathRegex: pathToRegexp(shared_utils_1.addLeadingSlash(route)),
                    };
                }
                return {
                    requestMethod: route.method,
                    pathRegex: pathToRegexp(shared_utils_1.addLeadingSlash(route.path)),
                };
            });
