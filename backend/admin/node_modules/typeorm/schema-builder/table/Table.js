...
var TableExclusion_1 = require("./TableExclusion");
/**
...
var Table = /** @class */ (function () {
    ...
    function Table(options) {
        ...
        if (options) {
            ...
            if (options.foreignKeys)
                this.foreignKeys = options.foreignKeys.map(function (foreignKey) { return new TableForeignKey_1.TableForeignKey((0, tslib_1.__assign)((0, tslib_1.__assign)({}, foreignKey), { referencedDatabase: (foreignKey === null || foreignKey === void 0 ? void 0 : foreignKey.referencedDatabase) || options.database, referencedSchema: (foreignKey === null || foreignKey === void 0 ? void 0 : foreignKey.referencedSchema) || options.schema })); });
            if (options.uniques)
            ...
            if (options.exclusions)
                this.exclusions = options.exclusions.map(function (exclusion) { return new TableExclusion_1.TableExclusion(exclusion); });
    ...
    Table.create = function (entityMetadata, driver) {
        ...
        var options = {
            ...
            exclusions: entityMetadata.exclusions.map(function (exclusion) { return TableExclusion_1.TableExclusion.create(exclusion); }),
        };
